document.addEventListener('DOMContentLoaded', () => {
    ...
    // Collision effect variables (NEW)
    ...
    // Enhanced collision detection with effects (NEW)
    ...
    // Enhanced draw function with screen shake and flash effects (NEW)
    function draw() {
